...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> checkAnswer(String username, String question, String answer) {
        ...
        if (userList.size() > 0) {
            ...
            RedisShardedPoolUtil.setEx(TokenCache.TOKEN_PREFIX + username,forgetToken,60*12);
    ...
    public ServerResponse<String> uodateForgetPassword(String username, String password, String token) {
        ...
        String tokenCache = RedisShardedPoolUtil.get(TokenCache.TOKEN_PREFIX + username);
