...
var _user = {
    ...
    checkUsername: function(username, resolve, reject) {
        _util.request({
            url: _util.getServerUrl('/user/check_valid'),
            data: {
                type: 'username',
                str: username
            },
    ...
    checkLogin: function(resolve, reject) {
        _util.request({
            url: _util.getServerUrl('/user/get_user_info'),
            method: 'POST',
            success: resolve,
            error: reject,
        });
    ...
    getQuesion: function(username, resolve, reject) {
        _util.request({
            url: _util.getServerUrl('/user/forget_get_question'),
            data: {
                username: username
            },
            method: 'POST',
    ...
    getUserInfo: function(resolve, reject) {
        _util.request({
            url: _util.getServerUrl('/user/get_information'),
            method: 'POST',
            success: resolve,
            error: reject,
        });
    ...
    updateUserInfo: function(userInfo, resolve, reject) {
        _util.request({
            url: _util.getServerUrl('/user/update_information'),
            data: userInfo,
            method: 'POST',
            success: resolve,
            error: reject,
    ...
    updatePasswordInfo:function(passwordInfo, resolve, reject) {
        _util.request({
            url: _util.getServerUrl('/user/reset_password'),
            data: passwordInfo,
            method: 'POST',
            success: resolve,
            error: reject,
